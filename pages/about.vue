    ...
    <div class="bg-gradient-to-r from-dark-800 to-dark-900 py-16">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-dark-300 max-w-2xl text-lg">
          A unified platform for single-cell analysis resources.
        </p>
      </div>
    </div>
        ...
        <section class="mb-16">
          ...
          <div class="prose dark:prose-invert max-w-none">
            <p class="text-dark-600 dark:text-dark-400 mb-4">
              <strong>SCPortal Hub</strong> is a unified web platform that combines two powerful single-cell analysis
              resources: the <strong>iAODE Dataset Browser</strong> and the <strong>LAIOR Benchmarking Dashboard</strong>.
            </p>
            <p class="text-dark-600 dark:text-dark-400 mb-4">
              Our goal is to provide researchers with a comprehensive resource for exploring single-cell datasets,
              understanding state-of-the-art analysis models, and comparing benchmarking results across different approaches.
            </p>
          </div>
        </section>
...
// Page metadata
useSeoMeta({
  title: 'About - SCPortal Hub',
  description: 'About SCPortal Hub - a unified platform for single-cell analysis resources'
})

const technologies = [
  { name: 'Nuxt', version: '3.15+', icon: '💚' },
  { name: 'Vue', version: '3.5+', icon: '🟢' },
  { name: 'Tailwind CSS', version: '4.0', icon: '🎨' },
  { name: 'TypeScript', version: '5.7+', icon: '📘' }
]
</script>
