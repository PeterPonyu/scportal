<template>
  <div class="min-h-screen">
    ...
    <div class="relative overflow-hidden border-b border-dark-800 bg-dark-900 py-12 sm:py-16">
      <div class="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-dark-500/70 to-transparent" />
      <div class="pointer-events-none absolute -left-24 top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-dark-600/10 blur-3xl" />
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="max-w-4xl mx-auto">
        ...
        <section class="mb-16">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a
              ...
              class="group p-6 rounded-2xl border border-dark-200 dark:border-dark-800 bg-white dark:bg-dark-900 block cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-primary-500/10 hover:-translate-y-1 hover:border-primary-300 dark:hover:border-primary-700"
            >
              ...
              <ul class="text-sm text-dark-600 dark:text-dark-400 space-y-2 mb-4">
              ...
              <span class="inline-flex items-center gap-2 text-sm font-medium text-primary-700 dark:text-primary-400">
                Online Browser
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="group p-6 rounded-2xl border border-dark-200 dark:border-dark-800 bg-white dark:bg-dark-900 block cursor-pointer transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-1 hover:border-emerald-300 dark:hover:border-emerald-700"
            >
        ...
        <!-- Technology Stack -->
        <section class="mb-16">
          <h2 class="text-2xl font-bold text-dark-900 dark:text-white mb-6">Technology Stack</h2>
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div v-for="tech in technologies" :key="tech.name" class="p-4 rounded-xl border border-dark-200 dark:border-dark-800 bg-white dark:bg-dark-900 text-center">
              <div class="text-2xl mb-2">{{ tech.icon }}</div>
              <div class="font-medium text-dark-900 dark:text-white text-sm">{{ tech.name }}</div>
              <div class="text-xs text-dark-500 dark:text-dark-400">{{ tech.version }}</div>
            </div>
          </div>
        </section>
        ...
        <!-- Contact -->
        <section>
          <h2 class="text-2xl font-bold text-dark-900 dark:text-white mb-6">Contact & Resources</h2>
          <div class="p-6 rounded-2xl border border-dark-200 dark:border-dark-800 bg-white dark:bg-dark-900">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 class="font-semibold text-dark-900 dark:text-white mb-4">Author</h3>
                <p class="text-dark-600 dark:text-dark-400 mb-2">Zeyu Fu</p>
                <a href="mailto:fuzeyu99@126.com" class="text-primary-700 dark:text-primary-400 hover:underline text-sm">
                  fuzeyu99@126.com
                </a>
              </div>
              <div>
                <h3 class="font-semibold text-dark-900 dark:text-white mb-4">Links</h3>
                <ul class="space-y-2">
                  <li>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      class="inline-flex items-center gap-2 text-sm text-primary-700 dark:text-primary-400 hover:underline"
                    >
...
const technologies = [
  { name: 'Nuxt', version: '3.15+', icon: 'N' },
  { name: 'Vue', version: '3.5+', icon: 'V' },
  { name: 'Tailwind CSS', version: '4.0', icon: 'T' },
  { name: 'TypeScript', version: '5.7+', icon: 'TS' }
]
</script>
