...
`remaining-lattice.json` (`router-author-lattice-v1`) freezes main-text admission at 30 cells / 18 study groups / 0 holdouts. Do not add observations until an unlock object listed in that file exists in `papers/evidence`.
